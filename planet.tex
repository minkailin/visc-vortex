...
\subsubsection{Potential vorticity}%how is vortex destroyed? use the visc-restart
We examine the PV evolution for case P0R to see how viscosity destroys
the vortex. To higlight the vortices, which are positive (negative)
density (vertical vorticity) perturbations, we show in Fig. the
inverse PV perturbation, $\eta_z(t=0)/\eta_z - 1$. 
