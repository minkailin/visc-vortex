...
in our cases).  {\bf Fig. \ref{planet_PV} shows a typical PV profile
...
\begin{figure}
  ...
  \caption{{\bf Potential vorticity profile for a planet gap before
...
$M_z \simeq 0.05,0.06$ (P1), respectively. %time averages
...
vortex is {\bf very elongated with large} aspect ratio
$\sim 10$ {\bf \cite[so the elliptic instability is weak,][]{lesur09}}.  
...
similarly {\bf to} Pb0: three vortices formed by $t\sim30P_0$, merging into two
