\section{Vortex formation at planetary gap edges}
...
%% However, unlike the special profile used in the previous experiment,
%% the present viscosity profile, Eq. \ref{planet_visc_profile}, 
%% will not be consistent with a steady gap in the absence of the
%% planet. Indeed, viscosity tries to close the gap and restore the
%% smooth disc profile \citep{lin86}. We therefore generally expect
%% viscous damping of the RWI. Our interest here is what happens when
%% viscosity is only  large away from the midplane. 
...
\begin{figure}
   ...
   \includegraphics[scale=.39,clip=true,trim=0cm 1.84cm 0cm
     0cm]{figures/jup0_pdisk005}\includegraphics[scale=.39,clip=true,trim=2.3cm
     1.84cm 0cm
     0cm]{figures/jup0_pdisk010}\\%% \includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 1.84cm 0cm
     %% 0cm]{figures/jup0_pdisk008}\includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 1.84cm 0cm
     %% 0cm]{figures/jup0_pdisk010}\includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 1.84cm 0cm
     %% 0cm]{figures/jup0_pdisk012}\includegraphics[scale=.27,clip=true,clip=true,trim=2.3cm 
     %% 1.84cm 0cm
     %% 0cm]{figures/jup0_pdisk014}\\
   \includegraphics[scale=.39,clip=true,trim=0cm 1.84cm 0.0cm
     0.99cm]{figures/jup2_nuamp10_pdisk005}\includegraphics[scale=.39,clip=true,trim=2.3cm
     1.84cm 0.cm
     0.99cm]{figures/jup2_nuamp10_pdisk010}\\%% \includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 1.84cm 0.cm
     %% 0.99cm]{figures/jup2_nuamp10_pdisk008}\includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 1.84cm 0.cm
     %% 0.99cm]{figures/jup2_nuamp10_pdisk010}\includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 1.84cm 0.cm
     %% 0.99cm]{figures/jup2_nuamp10_pdisk012}\includegraphics[scale=.27,clip=true,clip=true,trim=2.3cm
     %% 1.84cm 0.cm
   ...
   \includegraphics[scale=.39,clip=true,trim=0cm 0.cm 0.0cm
     ...
     0.cm 0.cm
     0.99cm]{figures/jup3_nuamp10_pdisk010}\\%% \includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 0.cm 0.cm
     %% 0.99cm]{figures/jup3_nuamp10_pdisk008}\includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 0.cm 0.cm
     %% 0.99cm]{figures/jup3_nuamp10_pdisk010}\includegraphics[scale=.27,clip=true,trim=2.3cm
     %% 0.cm 0.cm
     %% 0.99cm]{figures/jup3_nuamp10_pdisk012}\includegraphics[scale=.27,clip=true,clip=true,trim=2.3cm
     %% 0.cm 0.cm
