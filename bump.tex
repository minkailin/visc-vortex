\section{Non-axisymmetric instability of artificial density bumps in
...
initial PV minimum {\bf and surface density bump}. {\bf This further evidenced by  
  reduced vortex migration observed in Fig. \ref{vdamp0} with
  increased viscosity (e.g. the vortex in case V0 has migrated inwards to
  $R\simeq0.9r_0$ while that in case V3 remains near $R\simeq r_0$). This
  is because vortex migration can be halted by surface density bumps
  \citep{paardekooper10}.}  
...
effect outweighs viscous damping of the linear perturbations. {\bf We
  discuss additional simulations designed to test this hypothesis in
