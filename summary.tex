...
between high and low viscosity layers). Nevertheless, our simulations demonstrate %that viscous damping can
%significantly 
...
conceivable that vortex formation itself may render the effective
