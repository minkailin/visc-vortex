...
\begin{abstract}
  ...
  viscosity that is height-dependent. Two sets of numerical 
...
horizontal velocity perturbations have weak vertical dependence;  
...
simulations which show that the gap-edge vortex formation only
develops when the viscosity is sufficiently small
...
layered discs. As a first study of this problem, we take an
...
The question is whether or not applying a viscosity only in the upper
